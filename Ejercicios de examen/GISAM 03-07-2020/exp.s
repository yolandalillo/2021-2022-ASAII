...
# --- a ^ 3 = a * a * a
# --- ...
# --- Utiliza un bucle que realice iterativametne esas operaciones 
# --- tantas veces como indique el exponente

# --- Recomendaci√≥n: Si usas registros est√°ticos es m√°s sencillo....
# --- PERO aseg√∫rate de NO violar el convenio
...
exp:
	...
	#-- Se trata de una funcion intermdia, que llama a otra funciÛn
...
bucle:	
	...
	#-- Recuperar los registros est·ticos de la pila 
	lw s0, 8(sp)
	lw s1, 4(sp)
	lw s2, 0(sp)
