#-- Escribe un programa que saque por el display de 7 segmentos derecho una cuenta atrás: 9, 8, 7....0 al llegar 
#-- a 0 volverá otra vez mostrar el 9 y repetir la cuenta atrás indefinidamente (bucle infinito). 
...
tabla:	.word DIG9, DIG8, DIG7, DIG6, DIG5, DIG4, DIG3, DIG2, DIG1, DIG0 #-- Cuidado con el orden, esto es lo que cambia
