...
#-- Todavía no sabemos hacer bucles, así que las escrituras y las lecturas se hacen para las 4 posiciones de memoria, 
#-- una detrás de otra
#-- Para probarlo, bajar la velocidad a 29 instrucciones por segundo. De esta forma podrás ver de manera interactiva 
#-- cómo se van situando los valores en sus posiciones de memoria correspondientes
