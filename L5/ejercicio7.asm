...
#-- Inicializar el segmento de datos con los valores 1,2,3,4,5,6,7,8,9 y 10. 
#-- Se debe usar el caracter de salto de línea para separar los valores impresos en la consola. 
