#-- EJERCICIO 9
#-- Escribe un programa que pida al usuario una cadena (de tamaño máximo 1024 bytes) y cuente la cantidad 
#-- de caracteres 'a' que hay en ella. Ese resultado lo debe mostrar en la consola
